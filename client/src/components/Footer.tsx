      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="w-10 h-10 bg-[#cfb654] rounded-full flex items-center justify-center hover:bg-[#b8a047] hover:scale-110 transition duration-200 shadow-lg">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22.675 0h-21.35C.597 0 0 .597 0 1.333v21.333C0 23.403.597 24 1.325 24h11.495v-9.294H9.691v-3.622h3.129V8.413c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.097 2.795.141v3.24h-1.918c-1.504 0-1.796.715-1.796 1.765v2.316h3.587l-.467 3.622h-3.12V24h6.116C23.403 24 24 23.403 24 22.667V1.333C24 .597 23.403 0 22.675 0z" />
                </svg>
              </a>
              <a href="#" className="w-10 h-10 bg-[#cfb654] rounded-full flex items-center justify-center hover:bg-[#b8a047] hover:scale-110 transition duration-200 shadow-lg">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/contact" className="text-white hover:text-[#cfb654] transition duration-200 flex items-center font-medium">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6 text-sm">
              ...
              <a href="https://www.instagram.com/r_a_yen_00?igsh=MXEzNjJsc2lyNzkzZw==" className="text-white hover:text-[#cfb654] transition duration-200 font-medium">
                <AutoTranslate>Made with love</AutoTranslate>
              </a>
            </div>
          </div>
        </div>
