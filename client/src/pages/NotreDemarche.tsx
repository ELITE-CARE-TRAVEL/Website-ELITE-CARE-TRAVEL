      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-8">
            <div className="bg-gradient-to-r from-[#cfb654]/10 to-[#b8a047]/10 p-6 rounded-lg border-l-4 border-[#cfb654] text-center">
            ...
            <div className="bg-gradient-to-r from-[#05125d] to-[#0a1f7a] text-white p-8 rounded-lg text-center">
